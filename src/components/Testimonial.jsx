...
const Testimonial = () => {
  ...
  return (
    <div className="flex flex-col gap-8 md:flex-row md:items-center md:gap-14 my-24">
      <div
        className="py-5 px-4 flex justify-end w-full md:w-[666px]"
        style={{ backgroundImage: "url('base.png')", backgroundSize: 'cover' }}
      >
        <img className="border border-zinc-400 rounded-3xl w-[440px] h-[530px]" src={testimonial.imageSrc} alt="image" />
      </div>
